...
public class DisplayLiteralTable extends JFrame implements ActionListener, WindowListener
{
    JPanel panel = null;
    ...
    public DisplayLiteralTable(String literalfile, int s)
    {
        super("Literal Table");
        size=s;
        ...
        try
        {
            Scanner sc = new Scanner(new FileInputStream(new File(literalfile)));
        ...
        {
            JOptionPane.showMessageDialog(null, "Literal Table File not found!", "Error Message", JOptionPane.ERROR_MESSAGE);
            this.dispose();
        }
        catch(NoSuchElementException e)
        {
            JOptionPane.showMessageDialog(null, "Literal Table File incomplete!", "Error Message", JOptionPane.ERROR_MESSAGE);
            this.dispose();
        }
    }
